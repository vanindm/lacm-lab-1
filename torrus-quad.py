...
def draw():
    ...
    for poly in polys:
        ...
        canvas.create_polygon(int(polyProj[0][0] + WIDTH / 2), int(polyProj[0][1] + HEIGHT / 2), int(polyProj[1][0] + WIDTH / 2), int(polyProj[1][1] + HEIGHT / 2), int(polyProj[2][0] + WIDTH / 2), int(polyProj[2][1] + HEIGHT / 2), int(polyProj[3][0] + WIDTH / 2), int(polyProj[3][1] + HEIGHT / 2), fill='#0000' + "{0:02X}".format(max(0, min(255, int(INTENSITY * polyProj[0][2])))), outline='#000000')
    end = time.time()
